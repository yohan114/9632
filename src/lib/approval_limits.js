...
/** This person's limit for a kind of approval: an amount, or null for no limit. */
...
function whoCan(kind, value) {
  ...
  return ok.map((r) => r.label).concat('Admin');
}
...
module.exports = {
  KINDS, KIND_KEYS, limitFor, whoCan, check, refusal, refusalText, mrnValue, jobValue,
  listForScreen, setLimit, rs,
};
